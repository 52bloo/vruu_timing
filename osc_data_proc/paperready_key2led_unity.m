...
sslist_paths = {'./sslists/key2unityled_100hz.csv'}
fname_suffixes = {'100hz'};
...
peak_key2led_unity = peak_latencies;
    ...
    %legend(['Key sensor (' fname_suffixes{fsetup} ')| mean latency ' num2str(mean(peak_latencies)) 'ms)'], ['Unity LED (std. ' num2str(std(peak_latencies)) 'ms)']);
